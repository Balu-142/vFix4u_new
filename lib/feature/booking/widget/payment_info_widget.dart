...
class _PaidPaymentView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // double payAmount = bookingDetails.totalBookingAmount ?? 0; //Balu
    double payAmount = bookingDetails.due_amount ?? bookingDetails.totalBookingAmount ?? 0;
...
//   @override
//   Widget build(BuildContext context) {
//     print('Due Amount: ${bookingDetails.due_amount}');
//
//     bool isPartialPayment = bookingDetails.partialPayments !=null && bookingDetails.partialPayments!.isNotEmpty;
//     double payAmount = bookingDetails.due_amount ?? bookingDetails.totalBookingAmount ?? 0;
//
...
//     }
//
//     // Logic for showing Pay Now button based on due amount and isPaid status
//     bool shouldShowPayNowButton = false;
//
//     if (bookingDetails.due_amount != null && bookingDetails.due_amount! > 0) {
//       // If due amount exists and is greater than 0, show Pay Now button regardless of isPaid status
//       shouldShowPayNowButton = true;
//     } else if (bookingDetails.due_amount == null || bookingDetails.due_amount! <= 0) {
//       // If due amount is null or <= 0, follow isPaid status
//       shouldShowPayNowButton = bookingDetails.isPaid == 0;
//     }
//
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
...
//               ),
//
//               Text( shouldShowPayNowButton ? "unpaid".tr : "paid".tr,
//                 style: robotoMedium.copyWith(
//                   fontSize: Dimensions.fontSizeDefault + 1,
//                   color: shouldShowPayNowButton ? Theme.of(context).colorScheme.error : Colors.green,
//                 ),
//               ),
//             ]),
//             const SizedBox(height:Dimensions.paddingSizeSmall),
...
//             ) : const SizedBox(),
//
//             // Offline payment with existing payment info
//             (shouldShowPayNowButton && bookingDetails.paymentMethod == 'offline_payment' && bookingDetails.bookingOfflinePayment  != null &&  bookingDetails.bookingOfflinePayment!.isNotEmpty) ?
//             Padding(
//               padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraSmall),
//               child: Row(children: [
//                 Expanded(
...
//               ]),
//             )
//             // Offline payment without payment info
//                 : (bookingDetails.paymentMethod == 'offline_payment' && bookingDetails.bookingOfflinePayment == null && bookingDetails.bookingStatus != "canceled" && shouldShowPayNowButton) ?
//             Padding(
//               padding: const EdgeInsets.only(top: Dimensions.paddingSizeEight),
//               child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
//
...
//               ]),
//             )
//             // General Pay Now button for all other payment methods when shouldShowPayNowButton is true
//                 : shouldShowPayNowButton && bookingDetails.bookingStatus != "canceled" ?
//             Padding(
//               padding: const EdgeInsets.only(top: Dimensions.paddingSizeEight),
//               child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
//                 Container(
